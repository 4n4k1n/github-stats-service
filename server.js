...
app.get('/api/stats', async (req, res) => {
  ...
  try {
    ...
    // Estimate commits and lines (for demo - real implementation would need more API calls)
    const estimatedCommits = totalRepos * 25 + Math.floor(Math.random() * 500);
    const estimatedAdditions = Math.floor(estimatedCommits * (30 + Math.random() * 20));
    const estimatedDeletions = Math.floor(estimatedCommits * (5 + Math.random() * 10));
      ...
      <svg width="360" height="200" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(55, 135)">
          ...
          <text x="52.5" y="28" font-family="Segoe UI, sans-serif" font-size="19" font-weight="600" fill="#7ee787" text-anchor="middle" filter="url(#glow)">
            +${estimatedAdditions.toLocaleString()}
            <animate attributeName="fill" values="#7ee787;#90ff96;#7ee787" dur="3s" repeatCount="indefinite"/>
          </text>
          <text x="52.5" y="43" font-family="Segoe UI, sans-serif" font-size="10" fill="#7d8590" text-anchor="middle" letter-spacing="0.5px">LINES ADDED</text>
        </g>
        ...
        <g transform="translate(200, 135)">
          ...
          <text x="52.5" y="28" font-family="Segoe UI, sans-serif" font-size="19" font-weight="600" fill="#ff6b6b" text-anchor="middle" filter="url(#glow)">
            -${estimatedDeletions.toLocaleString()}
            <animate attributeName="fill" values="#ff6b6b;#ff8080;#ff6b6b" dur="3s" repeatCount="indefinite"/>
          </text>
          <text x="52.5" y="43" font-family="Segoe UI, sans-serif" font-size="10" fill="#7d8590" text-anchor="middle" letter-spacing="0.5px">LINES REMOVED</text>
        </g>
    ...
    const errorSvg = `
      <svg width="360" height="200" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="180" y="90" font-family="Arial, sans-serif" font-size="16" fill="#ff6b6b" text-anchor="middle">⚠️ Error loading stats</text>
        <text x="180" y="110" font-family="Arial, sans-serif" font-size="12" fill="#ff9999" text-anchor="middle">Check GitHub token or username</text>
